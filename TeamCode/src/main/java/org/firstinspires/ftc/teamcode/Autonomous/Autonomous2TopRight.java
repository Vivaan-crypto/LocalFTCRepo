...
public class Autonomous2TopRight extends OpMode {
    ...
    public void loop() {
        ...
        if (value >= 5 && value <= 10) {  // For this put the range of the amount of the distance from the wanted position of the robot to the the place where the oppositions ROBOT IS GOING TO BE PLACED and the amount of distance from the wanted position of the robot to the other wall
            fl.setPower(0.1);
            bl.setPower(-0.1);
            fr.setPower(-0.1);
            br.setPower(0.1);
