...
@Autonomous(name = "RightAuto2_DriveToBackBoard")
//Where in the driver program this will be found ^
public class RightAuto2_DriveToBackBoard extends LinearOpMode

{
    ...
    //Where in the driver program this will be found ^
    public static class RightAuto_DriveToBackBoard extends LinearOpMode
    {
        DcMotor fr, fl, br, bl;
        private Servo Claw1;
        //  private Servo Claw2;
